...
const projects = [
  ...
  },
  {
    ...
    github: "https://github.com/SenseiJha/Viral-Tweet-Location-Detector",
    demo: "https://github.com/SenseiJha/Viral-Tweet-Location-Detector/blob/main/Tweet%20Location.py",
